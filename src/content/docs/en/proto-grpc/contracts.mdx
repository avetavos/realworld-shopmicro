...
Now that real `.proto` files exist, resolve the `googleapis` dependency [Protobuf Tooling →](/shopmicro/en/setup/proto-tooling/)'s `buf.yaml` declared — this is the step that was impossible while `proto/` was empty, and it writes `buf.lock`, pinning the exact `googleapis` commit for everyone:
...
```text
Resolved buf.build/googleapis/googleapis, locked to a pinned commit in buf.lock.
```
...
```txt
proto/shopmicro/catalog/v1/catalog.proto:42:3:"shopmicro.catalog.v1.Product" is used as the request or response type for multiple RPCs.
proto/shopmicro/catalog/v1/catalog.proto:42:46:RPC response type "Product" should be named "GetProductResponse" or "CatalogServiceGetProductResponse".
proto/shopmicro/catalog/v1/catalog.proto:45:3:"shopmicro.catalog.v1.Product" is used as the request or response type for multiple RPCs.
proto/shopmicro/catalog/v1/catalog.proto:45:52:RPC response type "Product" should be named "CreateProductResponse" or "CatalogServiceCreateProductResponse".
proto/shopmicro/order/v1/order.proto:54:3:"shopmicro.order.v1.Order" is used as the request or response type for multiple RPCs.
proto/shopmicro/order/v1/order.proto:54:48:RPC response type "Order" should be named "CreateOrderResponse" or "OrderServiceCreateOrderResponse".
proto/shopmicro/order/v1/order.proto:57:3:"shopmicro.order.v1.Order" is used as the request or response type for multiple RPCs.
proto/shopmicro/order/v1/order.proto:57:42:RPC response type "Order" should be named "GetOrderResponse" or "OrderServiceGetOrderResponse".
```
