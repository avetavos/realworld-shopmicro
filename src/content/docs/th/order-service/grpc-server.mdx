...
เราต่อสาย client ตัวนี้เข้ากับ placeholder server ตั้งแต่วันนี้เลย แม้ `CreateOrder` จะยังไม่ได้เรียกใช้จนกว่าจะถึง [The Order Repository →](/shopmicro/th/order-service/order-repo/) คือ inject dependency ไว้ตอนนี้ ส่วน business logic ที่เรียกใช้ค่อยมาบทถัดไป
