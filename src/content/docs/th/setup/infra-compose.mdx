...
- `docker compose up -d` ตั้งเซอร์วิสทั้งสามตัวด้วยคำสั่งเดียว และ `healthcheck` ทำให้ tooling ที่พึ่งพาสามตัวนี้รอจน "พร้อมจริง ๆ" ไม่ใช่แค่ "container เริ่มแล้ว"
